	...
	if (!(str in letter_dict_cache)) {
		...
		let dict = {
			...
			"g": [
				...
				[[w*2/3, h*5/4], [w*2/3, h*3/2], [0, h*3/2], [0, h*5/4]]
			],
			"h": [
				[[0, 0], [0, h]],
